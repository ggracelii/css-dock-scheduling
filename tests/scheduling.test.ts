...
import { findConflicts, recommendBerths, vesselFitsBerth } from "../src/lib/scheduling";
...
const reservation: Reservation = { id: "existing", type: "vessel", title: "Existing", berthId: "large", startDate: "2026-05-10", endDate: "2026-05-12", origin: "created" };
